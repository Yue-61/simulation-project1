...
# ==========================================
# 6. RUN 15 REPLICATIONS
# ==========================================
NUM_REPLICATIONS = 15
SIM_TIME = 720 # 30 Days

# Lists to store the final KPI of each replication
rep_total_requests = []
rep_abandon_rates = []
rep_wait_times = []
rep_hourly_wages = []
...
print(f"Starting {NUM_REPLICATIONS} replications for Phase 1 Baseline...")
...
# ==========================================
# 7. PRINT FINAL AVERAGED RESULTS
# ==========================================
print("\n" + "="*50)
print(f"  PHASE 1 BASELINE RESULTS (Mean of {NUM_REPLICATIONS} Reps)  ")
print("="*50)
